...
listOfFileNames = textread('E:\OPS\OPS_All_EPrime_files\Retaliation\Task_1\text_file_paths.txt','%s'); 

numberOfFiles = length(listOfFileNames);
for k =  1 : numberOfFiles
    thisFile = listOfFileNames{k};
% 	 thisFile  = 'E:\OPS\OPS_All_EPrime_files\Retaliation\A00-00-2249_05032016_retaliation_task1and2.txt';
...
%     ScannerOnset = str2double(ScannerOnset(1));
    ...
    Task_Onset = DATA_Retaliation.Start_OnsetTimeTrial;
%      ScannerOnset  = 81000*ones(size(Task_Onset));
    Task_Onset = ((Task_Onset - ScannerOnset)/1000) - 12;
    Task_RT = DATA_Retaliation.Start_RTTimeTrial;
